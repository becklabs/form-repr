...
def parse_args():
    ...
    parser.add_argument("--config", type=str, default="configs/mb_ft_h36m.yaml", help="Path to the config file.")
    parser.add_argument('-e', '--evaluate', default='checkpoint/latest_epoch.bin', type=str, metavar='FILENAME', help='checkpoint to evaluate (file name)')
