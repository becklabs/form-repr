...
def main(input_dir: str, output_dir: str, is_3d: bool, overwrite: bool):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--is_3d', type=bool, default=True, help='whether to extract 3d keypoints')
    parser.add_argument('--overwrite', type=bool, default=False, help='whether to overwrite existing output file')
